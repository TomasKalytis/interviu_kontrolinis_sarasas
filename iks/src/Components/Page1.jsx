...
const listItemA = listA.map((listasA) => <li key={listasA}>{listasA}</li>);
const listItemB = listB.map((listasB) => <li key={listasB}>{listasB}</li>);
const listItemC = listC.map((listasC) => <li key={listasC}>{listasC}</li>);
